 ...
 */
final class Version20181208135811 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, poster_id INT NOT NULL, chronicle_id INT NOT NULL, date DATETIME NOT NULL, title VARCHAR(255) NOT NULL, is_valid TINYINT(1) NOT NULL, INDEX IDX_23A0E665BB66C05 (poster_id), INDEX IDX_23A0E66237D532E (chronicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66237D532E FOREIGN KEY (chronicle_id) REFERENCES chronicle (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E66237D532E');
